...
int main(){
    ...
    do{
        ...
        if(x < 10 && x > -10){
            if(inserirInicio(l1,x)) return 1; //se o número for de apenas um digito, ele adiciona no numero, senão ele sai
        }
    }while(x < 10 && x > -10);
    ...
    do{
        ...
        if(x < 10 && x > -10){
            if(inserirInicio(l2,x)) return 1; //se o número for de apenas um digito, ele adiciona no numero, senão ele sai
        }
    }while(x < 10 && x > -10);
